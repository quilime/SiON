...
package org.si.sound.mml {
    ...
    //--------------------------------------------------
        ...
        /** Set PCM data */
        public function setPCMData(index:int, serialized:Vector.<int>, samplingOctave:int) : void
        {
        ...
        /** Set wave data */
        public function setWaveData(index:int, rawData:Vector.<int>, channelCount:int) : void
        {
            waveData.push(MMLDataWaveTable.allocWaveData(index, rawData, channelCount));
        }
    }
}
...
class MMLDataWaveTable
{
    ...
    static public function allocWaveData(index:int, rawData:Vector.<int>, channelCount:int) : MMLDataWaveTable
    { 
        var e:MMLDataWaveTable = _freePCMList.pop() || new MMLDataWaveTable();
        e.type  = 2;
        e.index = index;
        e.waveFixedBits = channelCount;
        e.waveTable = rawData;
        return e;
    }
}
